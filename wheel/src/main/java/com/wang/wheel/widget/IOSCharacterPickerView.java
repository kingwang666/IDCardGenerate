...
public class IOSCharacterPickerView extends LinearLayout implements OnWheelChangedListener, View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProvince = (IOSWheelView) findViewById(R.id.id_province);
        mCity = (IOSWheelView) findViewById(R.id.id_city);
        mArea = (IOSWheelView) findViewById(R.id.id_area);
        ...
        int visibleItems = 5;
        int gravity = 0;
        int textColorOut = ContextCompat.getColor(context, R.color.wheel_text_color_out);
        int textColorCenter = ContextCompat.getColor(context, R.color.wheel_text_color_center);
        int dividerColor = ContextCompat.getColor(context, R.color.wheel_color_divider);
        ...
        try {
            wheelBg = typedArray.getResourceId(R.styleable.IOSCharacterPickerView_icp_wheelBackground, R.color.transparent);
            ...
            textColorOut = typedArray.getColor(R.styleable.IOSCharacterPickerView_icp_textColorUnselected, textColorOut);
            textColorCenter = typedArray.getColor(R.styleable.IOSCharacterPickerView_icp_textColorSelected, textColorCenter);
            dividerColor = typedArray.getColor(R.styleable.IOSCharacterPickerView_icp_dividerColor, dividerColor);
            dividerEnable = typedArray.getBoolean(R.styleable.IOSCharacterPickerView_icp_dividerEnable, true);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            typedArray.recycle();
        ...
        initWheel(wheelBg, gravity, textColorOut, textColorCenter, dividerColor, dividerEnable, isCycle, visibleItems, textSize);
    ...
    private void initWheel(int wheelBg, int gravity, int textColorOut, int textColorCenter, int dividerColor, boolean dividerEnable, boolean isCycle, int visibleItems, int textSize) {
    ...
    public void setTextColorCenter(int textColorCenter) {
        mProvince.setTextColorSelected(textColorCenter);
        mCity.setTextColorSelected(textColorCenter);
        mArea.setTextColorSelected(textColorCenter);
    }

    public void setTextColorOut(int textColorOut) {
        mProvince.setTextColorUnselected(textColorOut);
        mCity.setTextColorUnselected(textColorOut);
        mArea.setTextColorUnselected(textColorOut);
    }
