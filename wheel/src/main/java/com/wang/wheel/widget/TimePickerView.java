...
public class TimePickerView extends LinearLayout implements OnWheelChangedListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.TimePickerView, 0, 0);
        int startYear = typedArray.getInt(R.styleable.TimePickerView_tp_startYear, DEFAULT_START_YEAR);
        int endYear = typedArray.getInt(R.styleable.TimePickerView_tp_endYear, DEFAULT_END_YEAR);
        String minDate = typedArray.getString(R.styleable.TimePickerView_tp_minDate);
        String maxDate = typedArray.getString(R.styleable.TimePickerView_tp_maxDate);
        typedArray.recycle();
        ...
        mYearAdapter.setItemResource(R.layout.item_time);
        mYearWheel.setAdapter(mYearAdapter);
        mMonthAdapter = new NumericWheelAdapter(context, 0, 0, "%d月");
        mMonthAdapter.setItemResource(R.layout.item_time);
        mDayAdapter = new NumericWheelAdapter(context, 0, 0, "%d日");
        mDayAdapter.setItemResource(R.layout.item_time);
        updateWheel();
    }
