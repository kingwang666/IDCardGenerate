...
import com.wang.wheel.listener.OnWheelClickedListener;
import com.wang.wheel.listener.OnWheelScrollListener;
...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            startColor = typedArray.getColor(R.styleable.WheelView_wv_shadowsColorStart, ContextCompat.getColor(context, R.color.wheel_start_color));
            centerColor = typedArray.getColor(R.styleable.WheelView_wv_shadowsColorCenter, ContextCompat.getColor(context, R.color.wheel_center_color));
            endColor = typedArray.getColor(R.styleable.WheelView_wv_shadowsColorEnd, ContextCompat.getColor(context, R.color.wheel_end_color));

            dividerColor = typedArray.getColor(R.styleable.WheelView_wv_dividerColor, ContextCompat.getColor(context, R.color.wheel_color_divider));
            dividerEnable = typedArray.getBoolean(R.styleable.WheelView_wv_dividerEnable, dividerEnable);

            unselectedColor = typedArray.getColor(R.styleable.WheelView_wv_textColorUnselected, ContextCompat.getColor(context, R.color.wheel_text_color_out));
            selectedColor = typedArray.getColor(R.styleable.WheelView_wv_textColorSelected, ContextCompat.getColor(context, R.color.wheel_text_color_center));
    ...
    public void setColorUnselected(int unselectedColor) {
