...
import com.wang.wheel.adapters.AbstractWheelTextAdapter;
import com.wang.wheel.adapters.NumericWheelAdapter;
import com.wang.wheel.adapters.WheelViewAdapter;
import com.wang.wheel.listener.OnWheelChangedListener;
import com.wang.wheel.listener.WheelViewGestureListener;
...
public class IOSWheelView extends View {
    ...
    public IOSWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = ContextCompat.getColor(context, R.color.wheel_text_color_out);
        textColorCenter = ContextCompat.getColor(context, R.color.wheel_text_color_center);
        dividerColor = ContextCompat.getColor(context, R.color.wheel_color_divider);
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.IOSWheelView, 0, 0);
            mGravity = a.getInt(R.styleable.IOSWheelView_iwv_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.IOSWheelView_iwv_textColorUnselected, textColorOut);
            textColorCenter = a.getColor(R.styleable.IOSWheelView_iwv_textColorSelected, textColorCenter);
            dividerColor = a.getColor(R.styleable.IOSWheelView_iwv_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.IOSWheelView_iwv_textSize, textSize);
        ...
        if (isInEditMode()) {
            setAdapter(new NumericWheelAdapter(context, 1, 20));
            setCurrentItem(10);
        }
    }
    ...
    public void setTextColorUnselected(@ColorInt int textColorOut) {
    ...
    public void setTextColorSelected(@ColorInt int textColorCenter) {
    ...
    private String measuredCenterContentStart(String content) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN_MR1) {
            width = measuredWidth - getPaddingStart() - getPaddingEnd();
        } else {
